...
//        data = newArray(data, 3);
//        data[2] = "c";
//        for(String item : data)
//            System.out.println(item);
        //Set coleccion = new Set
        //HashSet<Producto> proCliente = new HashSet();
...
//            System.out.println(item);
        //System.out.println("------");
//        Set<String> coleccion = numeros;
//        coleccion.add("otro");
//        coleccion.add("uno");
//        for(String item : coleccion)
//            System.out.println(item);
//        LinkedHashSet<String> numerosLinked = new LinkedHashSet();
//        numerosLinked.add("7");numerosLinked.add("2");numerosLinked.add("3");
//        numerosLinked.add("5");numerosLinked.add("6");numerosLinked.add("1");
//        numerosLinked.add("3");
//        for(String item : numerosLinked)
//            System.out.println(item);
//        System.out.println("------");
//        HashSet<String> x = numerosLinked;
//        for(String item : x)
//            System.out.println(item);
//        System.out.println("------");
//        for(String item : x)
...
//        System.out.println("------");
    ...
    public static void main(String[] args) {
        ...
        Scanner cmd = new Scanner(System.in);
        CICLO : do{
            System.out.println("MENU TIENDA EL BARRIO\n1->Agregar un nuevo producto\n"
                    + "2->Elimar un producto\n0->Editar producto\n3->Nueva venta\n4->Listar productos\n"
                    + "5->Listar las ventas\n6->Salir");
            switch(cmd.nextInt()){
                case 0:
                    //editar
                ...
                case 1:
                    ...
                    String nombre = cmd.next(); double precio = cmd.nextDouble();
                    Producto nuevo = new Producto( nombre, precio);//1234
                    proCliente.add(nuevo);
                    proCliente.add(new Producto( nombre, precio));
                    proCliente.add(new Producto( nombre, precio+1000));
                    System.out.println("Producto agregado!!");
                    break;
                case 2:
                    //eliminar
//                    System.out.println(cmd.toString());
//                    System.out.println(new Producto( "CocaCola", 3450).toString());
                    break;
                case 3:
                    //Nueva venta
                    proCliente.clear();
                    //proCliente = new HashSet();
                    break;
                case 4:
                    //Listar compra
                    for(Producto item : proCliente)
    ...
    private static String[] newArray(String[] data, int nuevosItems){
        String[] x = new String[data.length+nuevosItems];
